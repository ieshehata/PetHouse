...
public class ChatsActivity extends AppCompatActivity implements ConversationAdapter.ConversationListener, View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        allButton.setOnClickListener(ChatsActivity.this);
        groupButton.setOnClickListener(ChatsActivity.this);
        privateButton.setOnClickListener(ChatsActivity.this);
        ...
        new ConversationController().getConversationsAlways(new ConversationCallback() {
            ...
            public void onSuccess(ArrayList<ConversationModel> conversations) {
                ...
                if(adapter == null || adapter.getData().size() == 0) {
                    if(listFilter == 0) {
                        adapter = new ConversationAdapter(generalChats, ChatsActivity.this);
                    }else if(listFilter == 1) {
                        adapter = new ConversationAdapter(groupChats, ChatsActivity.this);
                    }else if(listFilter == 2) {
                        adapter = new ConversationAdapter(privateChats, ChatsActivity.this);
                    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.all_button:
                ...
                groupButton.setBackgroundColor(ContextCompat.getColor(this, R.color.colorLightGray));
                groupButton.setTextColor(ContextCompat.getColor(this, R.color.colorPrimaryVeryDark));

                privateButton.setBackgroundColor(ContextCompat.getColor(this, R.color.colorLightGray));
                privateButton.setTextColor(ContextCompat.getColor(this, R.color.colorPrimaryVeryDark));
                filterUpdated();
                break;
            ...
            case R.id.group_button:
                ...
                groupButton.setBackgroundColor(ContextCompat.getColor(this, R.color.colorPrimaryDark));
                groupButton.setTextColor(ContextCompat.getColor(this, R.color.colorWhite));
            ...
            case R.id.private_button:
                ...
                privateButton.setBackgroundColor(ContextCompat.getColor(this, R.color.colorPrimaryDark));
                privateButton.setTextColor(ContextCompat.getColor(this, R.color.colorWhite));
                filterUpdated();
                break;
        }
    }
    ...
    public void deleteItem(int position) {
        ...
        new ConversationController().delete(adapter.getData().get(position), new ConversationCallback() {
            ...
            public void onSuccess(ArrayList<ConversationModel> conversations) {
                loadingHelper.dismissLoading();
                Toast.makeText(ChatsActivity.this, "deleted!", Toast.LENGTH_LONG).show();
            }
